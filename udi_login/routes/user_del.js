...
//========================================================================
//  curl -X POST -H "Content-Type: application/json" -d "{\"userid\":\"user7000\"}" http://127.0.0.1:13890/user/del
{
  ...
  try {
    ret_data = await sqlconn.query("CALL pc_tuser_del(?,@res, @res2)", [req_userid]); 
    //console.log(LOG_HEADER+"CALL pc_tuser_del("+req_userid+")=>", ret_data);
    ...
    ret_data = {
      code: "CALL pc_tuser_del(userid:"+req_userid+")",
